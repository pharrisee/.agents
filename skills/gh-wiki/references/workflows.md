...
8. **Create meta/events.jsonl**
   - Empty file, ready for append

9. **Log bootstrap event**
   ```json
...
3. **Process each integration target**
   ...
   c. **Decide**: Update or create new?
    ...
    d. **Create/update page**
       ...
       - Add citations: `[SRC-...](sources/SRC-....md)`
...
4. **Synthesize answer**
    ...
    - Cite with source page IDs: `[SRC-...](sources/SRC-....md)`
...
1. **Mechanical lint**
    ...
    a. **Broken links**
       - Grep for `[...](...)` patterns (Markdown links)
       - Verify target files exist
       - List broken: `[missing-page](missing-page.md)` in `sources/SRC-...]`
