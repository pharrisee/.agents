...
For detailed steps for each workflow, see [[references/workflows.md]].
...
For full details, see [[references/vault-structure.md]].
...
[Synthesized answer with citations like [[sources/SRC-...]]]

### Sources consulted
- [[sources/SRC-...]] — [brief description]
- [[sources/SRC-...]] — [brief description]
...
Full report: [[meta/lint-report.md]]
```
...
| Broken wikilink found in lint | Add to lint report, suggest fixes |
...
5. **Query** searches:
   ...
   - Presents: "According to [[sources/SRC-2026-04-14-001]], compute-optimal scaling... However, [[syntheses/chinchilla-vs-kaplan-laws]] notes tension with..."
...
**Symptom**: Audit shows broken `[[concepts/old-name]]`

**Fix Options**:
1. Update all links to new name (search/replace)
2. Create redirect page at old name with `[[concepts/new-name]]`
...
- [[references/vault-structure.md]] — Directory layout and folder purposes
- [[references/templates.md]] — All page templates and frontmatter reference
- [[references/workflows.md]] — Detailed step-by-step workflows
